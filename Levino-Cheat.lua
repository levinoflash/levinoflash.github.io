...
local tabs = {}
local tabNames = {"Legit", "Rage", "Visual", "World", "Settings"}
...
local function CreateSection(name, position, parent)
    ...
    function SF:BindToggle(text, default, callback)
        ...
        table.insert(activeBinds, bindData)
...
for i = 1, #tabNames do
    ...
    Padding.Parent = TabContents[i]
end


local LeftCol1, RightCol1 = CreateColumnContainer(TabContents[1])
local Sec1T1 = CreateSection("Legit Aimbot", UDim2.new(0,0,0,0), LeftCol1)
local Sec2T1 = CreateSection("Triggerbot", UDim2.new(0,0,0,0), RightCol1)
...
local LeftCol2, RightCol2 = CreateColumnContainer(TabContents[2])
local Sec1T2 = CreateSection("Rage Aimbot", UDim2.new(0,0,0,0), LeftCol2)
local Sec2T2 = CreateSection("Target Strafe", UDim2.new(0,0,0,0), RightCol2)
...
local LeftCol3, RightCol3 = CreateColumnContainer(TabContents[3])
local Sec1T3 = CreateSection("ESP", UDim2.new(0,0,0,0), LeftCol3)
local Sec2T3 = CreateSection("Chams", UDim2.new(0,0,0,0), RightCol3)
...
local LeftCol4, RightCol4 = CreateColumnContainer(TabContents[4])
local Sec1T4 = CreateSection("Movement", UDim2.new(0,0,0,0), LeftCol4)
local Sec2T4 = CreateSection("Player", UDim2.new(0,0,0,0), RightCol4)
...
local LeftCol5, RightCol5 = CreateColumnContainer(TabContents[5])
local Sec1T5 = CreateSection("Settings", UDim2.new(0,0,0,0), LeftCol5)
local Sec2T5 = CreateSection("Watermark", UDim2.new(0,0,0,0), RightCol5)
local Sec3T5 = CreateSection("Config", UDim2.new(0,0,0,0), RightCol5)
...
Sec2T5:Toggle("Enable Watermark", true, function(v) showWatermark = v end)
Sec2T5:Toggle("Show FPS", true, function(v) showFPS = v end)
Sec2T5:Toggle("Show Ping", true, function(v) showPing = v end)
Sec2T5:Toggle("Show Time", true, function(v) showTime = v end)
...
WatermarkText.Text = "Levino Cheat"
...
local function UpdateWatermark()
    ...
    Watermark.Size = UDim2.new(0, newWidth, 0, 25)
    Watermark.Position = UDim2.new(1, -newWidth - 10, 0, 10)
end
