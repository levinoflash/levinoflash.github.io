...
function Library:CreateWindow(title)
    ...
    Title.TextSize = 16
    Title.Text = title or "Levino Cheat"
    ...
    function Window:AddTab(name)
        ...
        Tab.Size = UDim2.new(1 / 5, 0, 1, 0)
        Tab.Position = UDim2.new((tabIndex - 1) / 5, 0, 0, 0)
        Tab.BackgroundTransparency = 1
        Tab.BorderSizePixel = 0
        Tab.Font = Enum.Font.Code
        Tab.TextSize = 14
        Tab.Text = name
        Tab.TextColor3 = (tabIndex == 1) and Color3.fromRGB(200, 200, 200) or Color3.fromRGB(120, 120, 120)
        Tab.TextXAlignment = Enum.TextXAlignment.Center
        Tab.Parent = TabContainer

        local TabContent = Instance.new("Frame")
        TabContent.Name = "TabContent" .. tabIndex
        ...
        Tab.Activated:Connect(function()
            ...
            if self.CurrentTab then
                self.Tabs[self.CurrentTab].Button.TextColor3 = Color3.fromRGB(120, 120, 120)
        ...
        local TabObj = {Button = Tab, Content = TabContent, LeftColumn = nil, RightColumn = nil}
...
function Library:CreateColumns(parent)
...
function Library:CreateSection(name, parent)
    ...
    function SF:Button(text, callback)
        ...
        ButtonOuter.Size = UDim2.new(1, 2, 1, 0)
        ButtonOuter.Position = UDim2.new(0, -1, 0, 0)
        ButtonOuter.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
        ButtonOuter.BackgroundTransparency = 0.85
        ButtonOuter.BorderSizePixel = 0
        ButtonOuter.Parent = ButtonFrame
    ...
    function SF:Dropdown(text, options, default, callback)
        ...
        MainButtonOuter.Position = UDim2.new(0, -1, 0, 18)
        ...
        local function CreateOptions()
            ...
            for i, option in ipairs(options) do
                ...
                OptionLabel.TextColor3 = (option == selected) and Color3.fromRGB(200, 200, 200) or Color3.fromRGB(180, 180, 180)
